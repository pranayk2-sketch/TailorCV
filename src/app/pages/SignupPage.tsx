      ...
      >
        <div className="bg-[#f5f1e8] rounded-3xl p-8 border-4 border-black shadow-xl">
          ...
          <p className="text-sm opacity-75 mb-6" style={{ fontWeight: 600 }}>
            Start building your tailored resumes
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" strokeWidth={3} />
                <input
                  type="text"
                  value={fullName}
          ...
          <p className="text-center mt-6 text-sm" style={{ fontWeight: 600 }}>
            ...
            <Link to="/login" className="text-[#ff6b6b] hover:underline" style={{ fontWeight: 800 }}>
              Sign in
            </Link>
          </p>
        </div>
